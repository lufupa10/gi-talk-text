...
const Chatbot = () => {
  ...
  const handleSubmit = async () => {
    if (name === '' || email === '' || message === '') {
      ...
      try {
        await axios.post('https://gitalk-back-email-1.onrender.com/send-email', {
          name,
          email,
          message,
        });
        ...
        <div className="form-popup">
          ...
          {closeForms === true ? (
            <form>
              ...
              </label>
              {
                formMsg.length ? (
                  ...
                  <div onClick={handleSubmit} className="formSend">Enviar</div>
                )
              }
            </form>
          ) : (
            <>
              ...
              <div className="formMsgTime">Em breve, entraremos em contato.</div>
            </>
          )
